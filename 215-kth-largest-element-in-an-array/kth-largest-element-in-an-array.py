...
# Note: The variable names 'start', 'end', 'k_smallest', 'pivot_index', 'pivot_value',
# 'left', and 'right' were chosen to improve clarity and adhere to standard naming conventions.
